{
	...
	"lastUpdated": "2024-06-15 03:32:43"
}
...
function getSearchResults(doc, checkOnly) {
	const items = {};
	let found = false;
	const rows = doc.querySelectorAll('.sl > a.title, .el-table__row > td:nth-child(2) a');
	for (let row of rows) {
		const href = row.href;
	...
	translator.setHandler('itemDone', (_obj, item) => {
		...
		switch (item.itemType) {
			...
			case 'thesis':
				...
				delete item.edition;
				labels.getWith('导师', true).querySelectorAll('a').forEach((element) => {
...
var testCases = [
	...
	{
		"type": "web",
		"url": "https://wwwv3.cqvip.com/doc/report/2910908558",
		"items": [
			{
				"itemType": "report",
		...
		"items": [
			{
				...
				"assignee": "张凯军",
				"country": "中国",
				"extra": "Genre: 实用新型\ncitation: 0\ndownload: 0\nIPC: B61H7/12(20060101)(2022.01)",
				"filingDate": "2012-04-05",
				"language": "zh-CN",
				"legalStatus": "未缴年费专利权终止",
				"patentNumber": "CN202827616U",
				"place": "中国",
				"rights": "1.一种轨道火车及高速轨道火车紧急安全制动辅助装置，其特征是：该制动辅助装置采用气压式推动原理被纵向安置在轨道火车及高速轨道火车的转向架同侧相邻两个轮毂之间，纵向投影与同侧两个轮毂及钢轨相重合，制动时可自由上下伸缩并能与钢轨相接触能增大火车的转向架与钢轨之间附着力及摩擦力矩的制动辅助装置；该装置由摩擦片、摩擦片座、导向移动柱、基座、回位弹簧、联动杆、制动气室推柱及制动气室组成。",
				"url": "https://wwwv3.cqvip.com/doc/patent/1992472003",
				"attachments": [],
				"tags": [],
				"notes": [],
	...
	{
		"type": "web",
		"url": "https://wwwv3.cqvip.com/doc/standard/2419214972",
		"items": [
			{
				"itemType": "standard",
	...
	{
		"type": "web",
		"url": "https://wwwv3.cqvip.com/doc/journal/2800794117",
		"items": [
			{
				"itemType": "journalArticle",
	...
	{
		"type": "web",
		"url": "https://wwwv3.cqvip.com/search?k=%E7%8E%B0%E4%BB%A3%E6%B1%89%E8%AF%AD",
		"items": "multiple"
	},
	{
		"type": "web",
		"url": "https://wwwv3.cqvip.com/advancesearch",
		"items": "multiple"
	},
	{
		"type": "web",
		"url": "https://wwwv3.cqvip.com/journal/1022577/column",
		"items": "multiple"
	}
]
/** END TEST CASES **/
